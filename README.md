...
| POIs | Pathfinding |
|-----------------|------------------|
| <img src="readme_imgs/global_poi.png" width="300" style="border:1px solid #ccc; border-radius:4px;"> | <img src="readme_imgs/pathfinding.png" width="300" style="border:1px solid #ccc; border-radius:4px;"> |